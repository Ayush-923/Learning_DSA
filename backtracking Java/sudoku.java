public class sudoku {
    ...
    public static boolean sudukosolver(int sudoku[][], int row, int col)
    {
        ...
        //not inseting if value is already there
        if(sudoku[row][col] != 0)
        {
        ...
        //for inserting values where there is a zero
    ...
    public static void main(String[] args) {
        ...
        {
            System.out.println("Sudoku doesNot exist");
        }
    }
}
